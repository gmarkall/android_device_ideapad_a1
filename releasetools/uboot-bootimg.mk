...
### ONLY FOR A1_07
INTERNAL_URAMDISKIMAGE_ARGS := -A ARM -O Linux -T RAMDisk -C none -e 0x80800000 -a 0x80800000 -n ramdisk-uboot -d $(BUILT_RAMDISK_TARGET)
...
### ONLY FOR A1_07
INTERNAL_RECOVERYRAMDISKIMAGE_ARGS := -A ARM -O Linux -T RAMDisk -C none -e 0x30800000 -a 0x30800000 -n recovery -d $(recovery_ramdisk)
